...
const HomePageSVG: React.FC = () => {
  return (
    ...
    >
      ...
      <rect y="218" className="st0" width="1920" height="641" />
      <path
        className="st1"
        d="M1920,1080l-80-35c-80-34-240-104-400-121s-320,17-480,52s-320,69-480,69s-320-34-400-52L0,976V717h80
          c80,0,240,0,400,0s320,0,480,0s320,0,480,0s320,0,400,0h80V1080z"
      />
      <path
        className="st1"
        d="M0,0l80,35c80,34,240,104,400,121s320-17,480-52s320-69,480-69s320,34,400,52l80,17v259h-80c-80,0-240,0-400,0
