  ...
  return (
    <div className={`w-1/5 pl-0 pr-0 pt-5`}>
      {isActive && (
        <div className="relative mb-4">
          <div
            ...
            style={{ width: '70%' }}
          >
            <div className="align-center z-10 mb-2 h-1 w-full flex-1 items-center rounded bg-primary align-middle "></div>
          </div>
          <div className=" z-30 mx-auto flex h-8 w-9 items-center rounded-full  text-lg text-white">
            <IoCheckmarkCircle size={35} className="rounded-full bg-primary" />
          </div>
      ...
      {!isActive && (
        <div className="relative mb-4">
          <div
            className="align-center absolute top-5 flex translate-x-[-50%] translate-y-[-50%] transform content-center items-center pb-2 align-middle "
            style={{ width: '70%' }}
          >
