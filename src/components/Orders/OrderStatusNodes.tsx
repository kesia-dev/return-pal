    ...
    <div className={`w-1/5 pl-0 pr-0 pt-5`}>
      {isActive && (
        <div className="relative mb-4">
          ...
          <p
            className="mb-2 w-full select-none space-x-10 pt-3 text-center text-lg text-black md:text-base"
      ...
      {!isActive && (
        <div className="relative mb-4">
          ...
          <p
            className="mb-2 w-full select-none space-x-10 pt-3 text-center text-xl text-gray-500 md:text-base"
            style={{ fontSize: '13.5px' }}
          >
            {label}
          </p>
