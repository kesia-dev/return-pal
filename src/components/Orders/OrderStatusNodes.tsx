...
// // Define props interface for OrderStatusNode component
// interface OrderStatusNodeProps {
//   label: string
//   isActive: boolean
// }

// // Define OrderStatusNode component
// const OrderStatusNode: React.FC<OrderStatusNodeProps> = ({
//   label,
//   isActive,
// }) => {
...
// // Define props interface for OrderStatusNodes component
// interface OrderStatusNodesProps {
//   order: { status: string } | undefined
// }

// // Define OrderStatusNodes component
// const OrderStatusNodes: React.FC<OrderStatusNodesProps> = ({ order }) => {
...
//     <div className="mt-4 flex items-center justify-center">
//       <div className="order-status-nodes-container flex space-x-0.5">
//         {/* Map through statuses and render OrderStatusNode component */}
//         {statuses.map((status) => (
//           <OrderStatusNode
//             key={status}
//             label={status}
