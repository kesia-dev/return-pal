...
export default function PackageInfo() {
  ...
  const [labelDescription, setLabelDescription] = useState<string>(
    'Label the item(s) inside: e.g. "laptop covers/"'
  )

  const handleDescriptionChange = () => {
    const desc = document.getElementById('description')
    console.log(desc)
    setLabelDescription(labelDescription?.valueOf)
  }
  ...
  return (
    <div className="mx-5 my-10 flex flex-col flex-wrap justify-around lg:mx-10">
      ...
      <div className="flex flex-col justify-between lg:flex-row">
        ...
        <div className="flex w-3/5 max-w-[90%] flex-row justify-between px-5 text-center md:flex-row">
