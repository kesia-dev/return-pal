...
export default function PackageInfo() {
  ...
  L265.13,75.602L231.035,41.507z"
          ...
          <Separator className="mx-[5%] h-0.5 w-[90%] shrink" />
        </div>
      )
    })
  }
  ...
  return (
    <div className="max-w-100% mx-5 my-10 flex flex-col flex-wrap justify-around lg:mx-10">
      ...
      <div className="flex flex-col justify-between lg:flex-row">
        <div className="w-4/5 max-w-full rounded-lg border-4 border-primary bg-white lg:w-2/5">
          <div id="labels" className="">
            <div className="flex flex-row bg-paleBlue font-bold text-primary lg:px-5 ">
              <div className="w-1/4 overflow-hidden text-clip break-all text-center lg:w-1/4">
                Attachment
              </div>
              <div className="w-1/4 overflow-hidden text-clip break-words text-center lg:w-1/4">
                Label Type
              </div>
              <div className="w-1/4 overflow-hidden truncate break-all text-center">
                Description
              </div>
              <div className=" overflow-hidden truncate break-all text-center"></div>
            </div>
            <Separator className="h-0.5 shrink bg-primary" />
            {/* <div className="flex flex-row py-4 lg:px-5">
              <div className="w-1/6 overflow-hidden truncate break-all text-center lg:w-1/4">
                label.png
              </div>
              <div className="w-1/6 overflow-hidden text-clip break-words rounded-full  bg-green-200 text-center lg:w-1/4">
                Digital
              </div>
              <div className="w-1/6 overflow-hidden text-clip break-all text-center lg:w-1/4">
                description
              </div>
              <div className="flex w-1/6 justify-around overflow-hidden text-clip break-words text-center lg:px-5">
                {' '}
                <div onClick={() => void console.log('editing')}>
                  <svg
                    className="fill-primary"
